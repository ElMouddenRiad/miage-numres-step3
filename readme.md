...
6. Cliquez sur "Ouvrir dans un navigateur"
7. Constater le Hot module Reload (HMR)
...
Pour chacune des propositions que vous faites, vous devez :
  ...
  4. Indiquez soit le gain en tailles de fichier, soit en nombre de requête soit en taille de requête.
  5. Commiter  & Pusher le code et le  fichier **_Questions.md_**
